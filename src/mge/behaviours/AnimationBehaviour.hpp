...
{
	public:
		AnimationBehaviour (std::vector <std::string> pAnimFiles);
		void update (float pStep) override;
		void playAnimation (int pAnimIndex, bool pLoop = false, void (*pFuncPtr) (int) = nullptr);
	...
	private:
		...
		void (*_stopFunction) (int) = nullptr;
};
